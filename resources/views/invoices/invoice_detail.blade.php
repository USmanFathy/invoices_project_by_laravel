                                                    ...
                                                    <div class="tab-pane" id="tab6">
                                                        <div class="card card-statistics">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <form method="post" action="{{ route('invoicesAttachment.store') }}"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">
                                                                                ...
                                                                                <a class="btn btn-outline-success btn-sm"
                                                                                   href="{{route('view_file',[$invoice->invoice_number ,$attach->file_name]) }}"
                                                                                   role="button"><i class="fas fa-eye"></i>&nbsp;
                                                                                    عرض</a>

                                                                                <a class="btn btn-outline-info btn-sm"
                                                                                   href="{{route('download',[$invoice->invoice_number ,$attach->file_name]) }}"
                                                                                   role="button"><i
