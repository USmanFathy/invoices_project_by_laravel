                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>القسم</span>
                                    <span>{{ $invoice->sections->section_name }}</span></p>
                            </div>
                        </div>
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="tx-right">{{ number_format($invoice->amount_comission, 2) }}</td>
                                    @php
                                        $total = $invoice->amount_collection + $invoice->amount_comission ;
                                    @endphp
                                    <td class="tx-right">
